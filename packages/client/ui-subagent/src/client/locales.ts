/**
 * ================================ 文件注释 ================================
 * 【文件职责】`subagent` 命名空间的双语文案字典（子代理目录、只读输入条与诊断）。
 * 【技术维度】zh 为键集基准（as const），en 受 Record<SubagentKey, string> 约束。
 * 【产品维度】子代理目录的加载/诊断/分支/计数文案与只读输入条提示。
 * 【逻辑维度】NS 常量、zh 键集、SubagentKey 推导、en 补齐。
 * 【关键边界】zh 是键的单一事实来源。
 * 【新手阅读建议】纯数据文件。
 * ==========================================================================
 */
