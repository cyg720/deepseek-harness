 ...
 * @remarks 文件说明：文件职责：验证 subagent/tool-subagent-control 中 test session
 * query 相关行为与失败场景。；技术维度：主要使用TypeScript/JavaScript 的 ESM 模块、严格类型约束与 Cordis
 ...
 * subagent/tool-subagent-control 在对应插件或业务生命周期内创建和调用。 */
