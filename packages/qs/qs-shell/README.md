---
description: "Build-only scaffold for Qishu application shell and developer UI switch."
...
Developers can compile and bundle the empty application shell and developer UI switch plugin. It has no user-visible behavior and is not mounted in the default Web composition.
