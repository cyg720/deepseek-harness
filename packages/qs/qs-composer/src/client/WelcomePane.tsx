...
export type QsWelcomePaneProps = PropsLocale<'qs-conversation'> & PropsRenderSlots<'qs.workspace.hero' | 'qs.workspace.hero.agentPreset'>
 ...
 * @returns 欢迎区节点。
 */
export function QsWelcomePane({ t, renderSlot }: QsWelcomePaneProps): ReactNode {
  ...
  return (
    <>
      ...
      <div data-qs-workspace-entry="hero">{renderSlot('qs.workspace.hero', {})}</div>
      {renderSlot('qs.workspace.hero.agentPreset', {})}
    </>
  )
}
