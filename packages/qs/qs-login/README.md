---
description: "Build-only scaffold for Qishu static login presentation."
...
Developers can compile and bundle the empty static login presentation plugin. It has no user-visible behavior and is not mounted in the default Web composition.
