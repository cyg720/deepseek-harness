/** `qs-schedule.catalog` namespace dictionaries. */

/** Dictionary namespace owned by this plugin. */
export const NS = 'qs-schedule.catalog'
...
export const zh = {
  ...
  'list.aria': '活动提醒',
  'list.limit': '只读目录；创建或取消请通过会话中的调度工具操作。时间按本机时区显示，逾期不代表执行失败。',
  'time.utc': 'UTC：{value}',
...
export const en: Record<ScheduleCatalogKey, string> = {
  ...
  'list.limit': 'Read-only catalog; create or cancel through Schedule tools in the conversation. Times use your local time zone; overdue does not mean execution failed.',
  'time.utc': 'UTC: {value}',
