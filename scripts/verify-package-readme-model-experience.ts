...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  'packages/qs/qs-shell': { kind: 'none', reason: 'Empty Host and Client scaffold entries; no model-facing registrations.' },
  'packages/qs/qs-login': { kind: 'none', reason: 'Empty Host and Client scaffold entries; no model-facing registrations.' },
  'packages/qs/qs-sessions': { kind: 'none', reason: 'Empty Host and Client scaffold entries; no model-facing registrations.' },
  'packages/qs/qs-composer': { kind: 'none', reason: 'Empty Host and Client scaffold entries; no model-facing registrations.' },
  'packages/qs/qs-transcript': { kind: 'none', reason: 'Empty Host and Client scaffold entries; no model-facing registrations.' },
  'packages/qs/qs-approval': { kind: 'none', reason: 'Empty Host and Client scaffold entries; no model-facing registrations.' },
  'packages/qs/qs-questions': { kind: 'none', reason: 'Empty Host and Client scaffold entries; no model-facing registrations.' },
