...
Source: [`packages/preset/agent-presets/src/session.ts:39`](../packages/preset/agent-presets/src/session.ts)
...
Source: [`packages/interaction/user-approval/src/types.ts:71`](../packages/interaction/user-approval/src/types.ts)
...
Source: [`packages/compaction/compaction/src/types.ts:78`](../packages/compaction/compaction/src/types.ts)
...
Source: [`packages/compaction/compaction/src/types.ts:88`](../packages/compaction/compaction/src/types.ts)
...
Source: [`packages/compaction/compaction/src/types.ts:30`](../packages/compaction/compaction/src/types.ts)
...
Source: [`packages/compaction/compaction/src/types.ts:40`](../packages/compaction/compaction/src/types.ts)
...
Source: [`packages/session/session-title-llm/src/index.ts:49`](../packages/session/session-title-llm/src/index.ts)
...
Source: [`packages/session/session-log-deepseek/src/types.ts:61`](../packages/session/session-log-deepseek/src/types.ts)
...
Source: [`packages/subagent/tool-subagent/src/model-selection-state.ts:27`](../packages/subagent/tool-subagent/src/model-selection-state.ts)
...
Source: [`packages/todo/tool-todo/src/types.ts:39`](../packages/todo/tool-todo/src/types.ts)
...
Source: [`packages/core/tools/src/types.ts:76`](../packages/core/tools/src/types.ts)
...
Source: [`packages/web/web-search-deepseek/src/provider.ts:101`](../packages/web/web-search-deepseek/src/provider.ts)
